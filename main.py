...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon.addPixmap(QtGui.QPixmap(image), QtGui.QIcon.Disabled, QtGui.QIcon.Off)
        icon.addPixmap(QtGui.QPixmap(image), QtGui.QIcon.Disabled, QtGui.QIcon.On)
        icon.addPixmap(QtGui.QPixmap(image), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon.addPixmap(QtGui.QPixmap(image), QtGui.QIcon.Active, QtGui.QIcon.On)
        icon.addPixmap(QtGui.QPixmap(image), QtGui.QIcon.Selected, QtGui.QIcon.Off)
        ...
        self.lineEdit_2.setGeometry(QtCore.QRect(190, 320, 300, 21))
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.label_3 = QtWidgets.QLabel(Form)
        self.label_3.setGeometry(QtCore.QRect(60, 320, 110, 21))
